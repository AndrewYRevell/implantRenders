...
layout: default
---
**_No identifying patient information is present._** _Only the brain surface 3D model, channel xyz coordinates, channel labels (e.g. LA1), and anonymized subject IDs are contained within this webpage. This webpage is intended to help view and navigate the implants in 3D space only._
